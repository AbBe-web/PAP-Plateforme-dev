...
const PATHOLOGY_KNOWLEDGE_REGISTRY = [
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Vigilance selon risque de chute et fracture, blessures musculosquelettiques et cutanées",
      "patient": ""
    },
    "condition": {
      "type": "always"
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Privilégier programme combiné : équilibre + renforcement MI + marche/endurance + coordination",
      "patient": ""
    },
    "condition": {
      "type": "always"
    ...
    "clinicalMoments": [
      {
        ...
        "messageClinicianOverride": "Au suivi, vérifier systématiquement les composantes réellement travaillées : équilibre, renforcement des membres inférieurs, marche ou endurance et coordination."
      }
    ],
    "evidenceSourceIds": [],
    "relatedResourceIds": [],
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Risque faible → autonomie / sport santé + éducation + rééval 12 mois",
      "patient": ""
    },
    "condition": {
      "type": "clinicianCheck",
      "description": "Niveau de risque faible présent ou à vérifier.",
      "machineEvaluable": false
    },
    "presentationTargets": [
      "orientation"
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Risque intermédiaire → APA ± kiné + éducation + rééval 12 mois",
      "patient": ""
    },
    "condition": {
      "type": "clinicianCheck",
      "description": "Niveau de risque intermédiaire présent ou à vérifier.",
      "machineEvaluable": false
    },
    "presentationTargets": [
      "orientation"
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Risque élevé → rééducation ± APA puis APA + rééval 30–90 j",
      "patient": ""
    },
    "condition": {
      "type": "clinicianCheck",
      "description": "Niveau de risque élevé présent ou à vérifier.",
      "machineEvaluable": false
    },
    "presentationTargets": [
      "orientation"
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Progressivité stricte",
      "patient": ""
    },
    "condition": {
      "type": "always"
    ...
    "clinicalMoments": [
      {
        ...
        "messageClinicianOverride": "Au suivi, vérifier systématiquement la progression réellement réalisée et sa tolérance."
      }
    ],
    "evidenceSourceIds": [],
    "relatedResourceIds": [],
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Intégrer exercices fonctionnels : demi-tour, obstacles, changement de cadence, relever du sol",
      "patient": ""
    },
    "condition": {
      "type": "always"
    ...
    "clinicalMoments": [
      {
        ...
        "messageClinicianOverride": "Au suivi, vérifier systématiquement les exercices fonctionnels réellement réalisés, leur tolérance et les difficultés rencontrées."
      }
    ],
    "evidenceSourceIds": [],
    "relatedResourceIds": [],
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Chaussage stable, éclairage suffisant, aides techniques adaptées",
      "patient": ""
    },
    "condition": {
      "type": "always"
    ...
    "clinicalMoments": [
      {
        ...
        "messageClinicianOverride": "Au suivi, vérifier systématiquement le chaussage, l’éclairage, les aides techniques utilisées et les incidents éventuels."
      }
    ],
    "evidenceSourceIds": [],
    "relatedResourceIds": [],
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Programmes utiles : <a href='https://vivifrail.com/fr/accueil/' target='_blank' rel='noopener noreferrer' style='display:inline;color:inherit;text-decoration:underline;'>VIVIFRAIL</a>, PEM-ES, <a href='https://www.agevillage.com/media/library/documents/Otago-French-Booklet.pdf' target='_blank' rel='noopener noreferrer' style='display:inline;color:inherit;text-decoration:underline;'>OTAGO</a>",
      "patient": ""
    },
    "condition": {
      "type": "always"
  ...
  },
  {
    ...
    "messages": {
      "clinician": "TUG et marche normaux = risque faible de chute",
      "patient": ""
    },
    "condition": {
      "type": "always"
  ...
  },
  {
    ...
    "messages": {
      "clinician": "TUG et/ou marche anormal = risque intermédiaire de chute",
      "patient": ""
    },
    "condition": {
      "type": "always"
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Toujours : bilan somatique + ergonomie domicile + peur de tomber",
      "patient": ""
    },
    "condition": {
      "type": "always"
  ...
  },
  {
    ...
    "messages": {
      "clinician": "SI absence progression → refaire bilan ± consultation chute/HDJ",
      "patient": ""
    },
    "condition": {
      "type": "clinicianCheck",
      "description": "Absence de progression constatée ou à vérifier.",
      "machineEvaluable": false
    },
    "presentationTargets": [
      "orientation"
    ...
    "clinicalMoments": [
      {
        ...
        "condition": {
          "type": "clinicianCheck",
          "description": "Absence de progression pendant la période de pratique.",
          "machineEvaluable": false
        },
        "messageClinicianOverride": "Au suivi, vérifier la progression, refaire le bilan si nécessaire et considérer une consultation chute ou un HDJ."
      }
    ],
    "evidenceSourceIds": [],
    "relatedResourceIds": [],
  ...
  },
  {
    ...
    "messages": {
      "clinician": "",
      "patient": "Bouger reste un traitement clé contre le risque de chute"
    },
    "condition": {
      "type": "always"
    },
  ...
  },
  {
    ...
    "messages": {
      "clinician": "",
      "patient": "Importance de travailler l’équilibre et la force"
    },
    "condition": {
      "type": "always"
    },
  ...
  },
  {
    ...
    "messages": {
      "clinician": "",
      "patient": "La peur de tomber se traite aussi par l’entraînement progressif"
    },
    "condition": {
      "type": "always"
    },
  ...
  },
  {
    ...
    "messages": {
      "clinician": "",
      "patient": "Signalez toute chute récente à votre médecin"
    },
    "condition": {
      "type": "always"
    },
  ...
  },
  {
    ...
    "messages": {
      "clinician": "",
      "patient": "Sécurisez le domicile : éclairage, tapis, obstacles"
    },
    "condition": {
      "type": "always"
    },
  ...
  },
  {
    ...
    "messages": {
      "clinician": "",
      "patient": "Contrôler régulièrement sa vue"
    },
    "condition": {
      "type": "always"
    },
  ...
  },
  {
    ...
    "messages": {
      "clinician": "",
      "patient": "Une alimentation adaptée aide aussi à préserver la force musculaire"
    },
    "condition": {
      "type": "always"
    },
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Pas de CI spécifique hors complications obstétricales",
      "patient": ""
    },
    "condition": {
      "type": "always"
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Vigilance selon état périnéal, cicatrisation, fatigue",
      "patient": ""
    },
    "condition": {
      "type": "always"
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Rééducation périnéale systématique surtout avant reprise AP avec impact",
      "patient": ""
    },
    "condition": {
      "type": "always"
    ...
    "clinicalMoments": [
      {
        ...
        "messageClinicianOverride": "Au suivi, vérifier systématiquement la rééducation périnéale effectuée, la reprise éventuelle d’une activité avec impact et la tolérance."
      }
    ],
    "evidenceSourceIds": [],
    "relatedResourceIds": [],
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Associer AP + apport calorique adapté pour perte et maintien pondéral",
      "patient": ""
    },
    "condition": {
      "type": "always"
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Allaitement : AP possible si apports énergétiques suffisants et brassière adaptée",
      "patient": ""
    },
    "condition": {
      "type": "always"
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Avant CS postnatale : AP légère à modérée (marche, escaliers, natation)",
      "patient": ""
    },
    "condition": {
      "type": "always"
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Après CS postnatale : prescription rééducation périnéale + conseils reprise AP ± sport",
      "patient": ""
    },
    "condition": {
      "type": "always"
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Reprise AP avec impact <button type='button' class='info-trigger info-hitbox' data-info='Course à pied, trampoline, activités avec sauts'><span class='info-icon'>i</span></button> si fonction périnéale normale (4–6 sem si RAS, 8–10 sem si césarienne/épisiotomie, parfois moins)",
      "patient": ""
    },
    "condition": {
      "type": "clinicianCheck",
      "description": "Reprise d’une activité physique avec impact envisagée ou réalisée, avec fonction périnéale à vérifier.",
      "machineEvaluable": false
    },
    "presentationTargets": [
      "prescription.general"
    ...
    "clinicalMoments": [
      {
        ...
        "condition": {
          "type": "clinicianCheck",
          "description": "Reprise d’une activité physique avec impact pendant la période de pratique.",
          "machineEvaluable": false
        },
        "messageClinicianOverride": "Au suivi, vérifier la fonction périnéale, le délai de reprise, l’activité réellement réalisée et sa tolérance."
      }
    ],
    "evidenceSourceIds": [],
    "relatedResourceIds": [],
  ...
  },
  {
    ...
    "messages": {
      "clinician": "Femme sportive : reprise progressive endurance (privilégier faible impact initial), reprise renforcement progressive avec travail du plancher pelvien",
      "patient": ""
    },
    "condition": {
      "type": "clinicianCheck",
      "description": "Femme sportive reprenant une activité d’endurance ou de renforcement présente ou à vérifier.",
      "machineEvaluable": false
    },
    "presentationTargets": [
      "prescription.general"
    ...
    "clinicalMoments": [
      {
        ...
        "condition": {
          "type": "clinicianCheck",
          "description": "Reprise sportive d’endurance ou de renforcement pendant la période de pratique.",
          "machineEvaluable": false
        },
        "messageClinicianOverride": "Au suivi, vérifier la progression réellement réalisée, l’impact des activités, le renforcement et le travail du plancher pelvien."
      }
    ],
    "evidenceSourceIds": [],
    "relatedResourceIds": [],
  ...
  },
  {
    ...
    "messages": {
      "clinician": "SI symptômes périnéaux (fuites, pesanteur, douleur) → différer AP avec impact et réévaluer",
      "patient": ""
    },
    "condition": {
      "type": "clinicianCheck",
      "description": "Symptômes périnéaux tels que fuites, pesanteur ou douleur présents ou à vérifier.",
      "machineEvaluable": false
    },
    "presentationTargets": [
      "prescription.general"
    ...
    "clinicalMoments": [
      {
        ...
        "condition": {
          "type": "clinicianCheck",
          "description": "Symptômes périnéaux pendant la période de pratique.",
          "machineEvaluable": false
        },
        "messageClinicianOverride": "Au suivi, vérifier les symptômes périnéaux, le report éventuel des activités avec impact et la réévaluation réalisée."
      }
    ],
    "evidenceSourceIds": [],
    "relatedResourceIds": [],
  ...
  },
  {
    ...
    "messages": {
      "clinician": "SI bonne tolérance → progression graduelle",
      "patient": ""
    },
    "condition": {
      "type": "always"
    ...
    "clinicalMoments": [
      {
        ...
        "condition": {
          "type": "clinicianCheck",
          "description": "Bonne tolérance de la pratique présente ou à vérifier.",
          "machineEvaluable": false
        },
        "messageClinicianOverride": "Au suivi, vérifier la tolérance et la progression graduelle réellement effectuée."
      }
    ],
    "evidenceSourceIds": [],
    "relatedResourceIds": [],
  ...
  },
  {
    ...
    "messages": {
      "clinician": "",
      "patient": "Bouger après l’accouchement aide à récupérer et réduit le risque de dépression"
    },
    "condition": {
      "type": "always"
    },
  ...
  },
  {
    ...
    "messages": {
      "clinician": "",
      "patient": "L’activité physique est compatible avec l’allaitement"
    },
    "condition": {
      "type": "always"
    },
  ...
  },
  {
    ...
    "messages": {
      "clinician": "",
      "patient": "Reprendre progressivement en fonction de son ressenti"
    },
    "condition": {
      "type": "always"
    },
  ...
  },
  {
    ...
    "messages": {
      "clinician": "",
      "patient": "Le travail du périnée est essentiel avant les activités à impact"
    },
    "condition": {
      "type": "always"
    },
